...
SELECT
    "Day" as day,
      "Outstanding Loans (USD)" as outstanding_loans_comp
FROM tokenskpi3
ORDER BY "Day" DESC
...
borrows AS (
    ...
    (
        ...
        FROM lending."borrow"
        WHERE project IN ('MakerDAO', 'AAVE')
...
WHERE b.day BETWEEN '2021-11-10' AND '2022-03-28'
AND project IN ('MakerDAO', 'AAVE')
GROUP BY 1, 2
)
...
AAVE AS (
    ...
    WHERE s1.day BETWEEN '2021-11-10' AND '2022-04-01'
    ORDER BY 1 DESC
    )
...
SELECT
    o.day,
    o.project, 
    y.total_debt as "Aave Debt",
    outstanding_usd_value as "Maker Debt",
    locked_usd_value,
    z.outstanding_loans_comp as "COMP Debt"
FROM all_outstanding o
    LEFT JOIN COMP z on z.day = o.day
    LEFT JOIN AAVE y on y.day = o.day
